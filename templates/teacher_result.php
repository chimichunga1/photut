...
/*      $table2 = "SELECT user_accounts.user_id, user_accounts.user_fname, user_accounts.user_lname, user_accounts.username, user_accounts.password 
 ...
 $table2 .="inner join section_table s on s.section_id=t.section_id ";
 $table2 .="where  t.prof_id='".$uid."' group by s.section_id  ";
...
<tr>
            ...
            <button class="btn btn-success btn-block" name="teacher_quiz_score"> <strong>VIEW</strong></button>
                </form>
                </td>
</tr>
