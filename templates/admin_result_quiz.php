...
/*      $table2 = "SELECT user_accounts.user_id, user_accounts.user_fname, user_accounts.user_lname, user_accounts.username, user_accounts.password 
 ...
 $table2 ="select * from  quiz_table q ";
 $table2 .="where  q.section_id='".$sid."' ";
...
<tr>
            ...
            <button class="btn btn-success btn-block" name="admin_quiz_score_view"> <strong>VIEW</strong></button>
                </form>
                </td>
</tr>
